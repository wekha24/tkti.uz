        ...
        <div class="row">
            ...
            <div class="teachers">
                    <div class="wrapper-personal">
                        <div class="photo-personal">
                            ...
                            <div class="photo__large">
                                <div class="bg-text">
                                    ...
                                    <span class="info">Kadirov Ulug'bek Ravshanovich
                        ...
                        <h6 class="fullname-personal">Kadirov Ulug'bek Ravshanovich</h6>
                    </div>
                    <div class="wrapper-personal">
                        <div class="photo-personal">
                            ...
                            <div class="photo__large">
                                <div class="bg-text">
                                    <span class="degree">Uslubchi</span>
                                    <span class="info">Boymatov Sardorjon Isomiddin o‘gli
                        ...
                        <h6 class="fullname-personal">Boymatov Sardorjon Isomiddin o‘gli</h6>
                    </div>
                    <div class="wrapper-personal">
                        <div class="photo-personal">
                            ...
                            <div class="photo__large">
                                <div class="bg-text">
                                    ...
                                    <span class="info">Umarjonov Qodirjon Qobiljon o‘gli
                        ...
                        <h6 class="fullname-personal">Umarjonov Qodirjon Qobiljon o‘gli</h6>
                    </div>
                </div>
            </div>
        </div>
