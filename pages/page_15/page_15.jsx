        ...
        <div class="row">
            ...
            <div class="teachers">
                    <div class="wrapper-personal">
                        <div class="photo-personal">
                            ...
                            <div class="photo__large">
                                <div class="bg-text">
                                    ...
                                    <span class="info">Babakhanova Zebo Abdullaevna
                                        <br/>
                        ...
                        <h6 class="fullname-personal">Babakhanova Zebo Abdullaevna</h6>
                    </div>
                    <div class="wrapper-personal">
                        <div class="photo-personal">
                            ...
                            <div class="photo__large">
                                <div class="bg-text">
                                    <span class="degree">Uslubchisi</span>
                                    <span class="info">Saidaxmadov Saidumarxon Saidabror o’g’li
<br/>
                        ...
                        <h6 class="fullname-personal">Saidaxmadov Saidumarxon Saidabror o’g’li</h6>
                    </div>
